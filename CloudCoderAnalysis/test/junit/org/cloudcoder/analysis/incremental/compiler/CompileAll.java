    ...
    throws Exception
    {
        ...
        for (LineEdit change : lineChanges) {
    		...
    		try {
    			...
    			System.out.println("Exception " + e.getClass() + ", exiting this pair.");
    			// some error occurred either with the data or LineEdit code, skip for now
    			stmt = conn.createStatement();
    	        query = "UPDATE e_status SET done = 0, in_progress = -1 WHERE user_id = " + userID + " AND problem_id = " + problemID + ";";
